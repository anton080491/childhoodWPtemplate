...
<div class="toys">
    <div class="container">
        <h2 class="subtitle"><a href="http://childhood/stuf_toys/">Мягкие игрушки</a></h2>
        <div class="toys__wrapper">
        <?php
            // параметры по умолчанию
            $posts = get_posts( array(
                'numberposts' => -1,
                'category_name'    => 'stuf_toys',
                'orderby'     => 'date',
                'order'       => 'ASC',
                'post_type'   => 'post',
        ...
        <h2 class="subtitle"><a href="http://childhood/edu_toys/">Развивающие игрушки</a></h2>
        <div class="toys__wrapper">
        <?php
            // параметры по умолчанию
            $posts = get_posts( array(
