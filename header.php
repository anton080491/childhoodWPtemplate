                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="mailto:mirdetstva@gmail.com" class="header__contacts-mail"><?php the_field('contacts-mail',2); ?></a>
                            </div>
                            <div class="header__contacts-item">
                                ...
                                <div class="header__contacts-tel">
                                    <a href="tel:+797867834347"><?php the_field('contacts-tel1',2); ?></a>
                                    <a href="tel:+797867834358"><?php the_field('contacts-tel2',2); ?></a>
                                </div>
                            </div>
                            <div class="header__contacts-item">
